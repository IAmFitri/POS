            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="nama_pemasok" class="col-md-2 col-md-offset-1 control-label">Nama Pemasok</label>
                        <div class="col-md-6">
                            <input type="text" name="nama_pemasok" id="nama_pemasok" class="form-control" required autofocus>
